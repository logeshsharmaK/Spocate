...
class _MyCarsState extends State<MyCars> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, RouteConstants.ROUTE_ADD_CAR,
              arguments: AddCarNavFrom.MyCars);
        },
        child: const Icon(
          Icons.add,
          color: Colors.white,
        ...
        Positioned(
          child: ElevatedButton(
            child: (carItem.isdefault == 1)
                ? Text(
                    WordConstants.MY_CARS_BUTTON_CURRENT_DEFAULT,
                  )
                : Text(
                    WordConstants.MY_CARS_BUTTON_SET_DEFAULT,
                  ),
            ...
            onPressed: () async {
              if (index != 0 &&
                ...
                _updateIsDefaultToService(carItem);
              }
            },
          ),
          top: -6,
  ...
  _updateIsDefaultToService(CarItem carItem) async {
      ...
      await NetworkUtils()
        ...
        if (isInternetAvailable) {
          _myCarsUpdateBloc.add(
              MyCarsUpdateClickEvent(myCarsUpdateRequest: myCarsUpdateRequest));
        } else {
          AppWidgets.showSnackBar(
              context, MessageConstants.MESSAGE_INTERNET_CHECK);
        }
  ...
  _blocMyCarsUpdateListener(BuildContext context, MyCarsUpdateState state) {
